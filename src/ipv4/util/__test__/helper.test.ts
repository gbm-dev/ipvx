// src/ipv4/util/__tests__/helper.test.ts
...
import {
  ...
  describe('IPv4 Helper Functions', () => {
    describe('assertIPv4Address', () => {
      ...
      it('should throw an error for invalid IPs', () => {
        const invalidIPs = [
          ...
          ' 192.168.1.1 ',    // Leading and trailing whitespace
          '\t192.168.1.1',    // Leading tab
          '192.168.1.1\n',    // Trailing newline
      ];
    ...
    // Removed the following test as it contradicts the helper's behavior
    /*
